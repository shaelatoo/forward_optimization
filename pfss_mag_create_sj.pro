pro pfss_mag_create_sj,magout,magtype,nlat0,gridtype,file=file,quiet=quiet

; this is a temporarily revised version of the routine pfss_mag_create 
...
;   to parse the initial longitude from the ".mrbqs" header file
    ...
    0: begin  ;  IDL save file filled with flux concentrations
      ...
      case size(file(0),/type) of
        ...
        8: begin  ;  structure
          ...
          print,'  ERROR in pfss_mag_create:  file keyword not valid'
          return
        end
      endcase
